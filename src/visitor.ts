...
export abstract class NodeVisitor<T> {
  ...
  protected abstract visitReturnStatement(node: ts.ReturnStatement): T;
	...
	protected abstract visitVariableDeclarationList(node: ts.VariableDeclarationList): T;
	...
	protected abstract visitPostfixUnaryExpression(node: ts.PostfixUnaryExpression): T;
